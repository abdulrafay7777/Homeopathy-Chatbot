...
const BASE_STEPS = [
  ...
  },
  {
    ...
    type: 'text',
    title: 'Phone Number',
    subtitle: 'Dusra sawal — apna phone number darj karen',
    placeholder: 'Phone number yahan likhen (e.g. 03001234567)...',
  },
  {
    key: 'age',
    type: 'mcq',
    title: 'Umar kya hai?',
    subtitle: 'Teesra sawal — umar ki range chunen',
  ...
  },
  {
    ...
    type: 'mcq',
    title: 'Jins (Gender)?',
    subtitle: 'Chautha sawal — gender select karen',
  ...
  },
  {
    ...
    subtitle: 'Panchwa sawal — marital status',
